...
const EditRestaurant = ({ formType }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    let updatedRestaurantId = updatedRestaurant.restaurant.id;
    if (updatedRestaurant) {
      history.push(`/restaurants/${updatedRestaurantId}`);
      dispatch(restaurantActions.getRestaurant(updatedRestaurantId));
    }
  };
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="form">
        Street Address
        <input type="text" placeholder="Street address" required value={address} onChange={updateAddress} />
        City
        <input type="text" placeholder="City" required value={city} onChange={updateCity} />
        Zip Code
        <input type="text" placeholder="Zip Code" value={zip_code} onChange={updateZip_code} />
        State
        <input type="text" placeholder="State" required value={state} onChange={updateState} />
        Opens
        <TimePicker required onChange={() => setOpen} value={open} />
        Closes
        <TimePicker required onChange={() => setClose} value={close} />
        ...
        Phone
        <input type="number" placeholder="Phone Number" value={phone} onChange={updatePhone} />
        Logo
        <input type="text" placeholder="Logo" value={logo} onChange={updateLogo} />
        Food Type
        <input type="text" placeholder="Food Type" value={food_type} onChange={updateFood_type} />
